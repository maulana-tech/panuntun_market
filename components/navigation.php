...
$navigation = [
    ...
    [
        ...
        'children' => [
            ['name' => 'Users', 'href' => BASE_URL . '/pages/users.php', 'current' => $currentPage === 'users'],
            ['name' => 'Suppliers', 'href' => BASE_URL . '/pages/suppliers.php', 'current' => $currentPage === 'suppliers'],
            ['name' => 'Products', 'href' => BASE_URL . '/pages/products.php', 'current' => $currentPage === 'products']
        ]
    ],
    [
        'name' => 'Transactions',
        ...
        'roles' => ['Admin'], // Hanya dapat diakses oleh Admin
        'children' => [
            ['name' => 'Sales', 'href' => BASE_URL . '/pages/sales.php', 'current' => $currentPage === 'sales'],
            ['name' => 'Purchases', 'href' => BASE_URL . '/pages/purchases.php', 'current' => $currentPage === 'purchases']
        ]
    ],
    [
        'name' => 'Reports',
